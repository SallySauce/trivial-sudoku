// @FIXME: Oh no, please don't #include everything into one source file
// anymore, I polluting the global namespace!!!!

// @TODO: Optimize the memory allocation. Oh everything is on the stack,
// never mind.
...
struct Dance {
    ...
    Dance(char inout[81]) : inout_(inout), cur_node_(0) {
        stack_.reserve(100);
